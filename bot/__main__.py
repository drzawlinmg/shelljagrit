...
def start(update, context):
    sendMessage("Hello! ဘော့ဒ် စကူးလို့ရပါပြီ" \
        "\n  /help နှိပ်ပြီး အသေးစိတ်လေ့လာပါ။",
    context.bot, update, 'Markdown')
    # ;-;

@run_async
def helper(update, context):
    sendMessage("Source Drive နှင့် ကူးမည့်မိမိShareDrive တိုတွင် Botတည်ဆောက်သူဖော်ပြထားသော *GorupMail* ကို *cotributor* အဖြစ် add ထားမှ ကူးလိုရမှာပါ။ addနည်းကို ဒီမှာကြည့်ပါ။https://tiny.one/dwtykxca\n\n" \
